...
/**
* This class draw polynom in new window and calculate the extreme points for the Gui and show than in red.
* the site that helps us: https://github.com/eseifert/gral/wiki/xyplot
* there is main of the specific func that we asked for and print it.
*@author Bar Genish
*@author elyashiv deri
*/
public class Functions_GUI extends JFrame {
	...
	public Functions_GUI(Polynom _p, double x0, double x1, double _eps) {
